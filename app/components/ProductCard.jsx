...
const ProductCard = ({card}) => {
    return (
        <div
             className={`flex-1 w-[308px] relative pb-[20px] border-b border-[#13171D] py-[20px] pr-[20px] rounded-[6px] bg-[#13171D]`}>
            ...
            <div className='card-container w-full h-[234px] relative left-[0px] mb-[18px] overflow-hidden'>
                <Image
                    ...
                    height={234} className='object-cover w-full h-full duration-300'/>
            </div>
            <p className={`pl-[20px] font-satoshi w-full text-[16px] text-white leading-[130%] pb-[30px]`}>
                {card.text}
            </p>
        </div>
    )
