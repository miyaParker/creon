                    ...
                    <div className='flex flex-col gap-x-[45px] overflow-hidden'>
                        <div className='relative z-40'>
                            ...
                            <button
                                ...
                                <p className='btn-child-1 duration-300 ease-out delay-75 text-center'>Buy
                                    Creon Pass</p>
                                <p className='btn-child-2 duration-300 ease-out delay-75 text-center translate-y-[100%]'>Buy
                                    Creon Pass</p>
                            </button>
                        </div>
                    </div>
