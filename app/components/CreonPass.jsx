        ...
        <section className='bg-black w-full'>
            <div
                ...
                <div>
                    ...
                    <h3 className='gradient-text font-satoshi font-bold w-full text-[18px] text-white leading-[130%] mb-[25px]'>
                    ...
                    <div className='flex flex-col lg:items-center gap-x-[45px] max-w-full overflow-hidden'>
                        ...
                        <div className='md:absolute md:left-[30px] xl:left-[120px] 2xl:left-[240px] flex flex-col gap-[15px]'>
