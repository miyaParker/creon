...
const Products = () => {
    ...
    return (
        <div className='w-full relative w-full h-max overflow-hidden'>
            <div
                className='bg-[#13171D] bg-opacity-60 xl:bg-black xl:hidden max-w-[1920px] relative z-50 md:px-[30px] xl:px-[120px] 2xl:px-[240px] mx-auto overflow-scroll lg:overflow-hidden py-[76px] md:py-[204px] bg-black'>
