...
const MobileMenu = () => {
    return (
        <div className='w-screen screen-h fixed bottom-0 left-0'>
            <motion.div initial={{x: 208}} animate={{x: 0}} exit={{x: 208}}
            ...
            <motion.div initial={{backdropFilter: 'none', backgroundColor: 'transparent'}}
                        animate={{backdropFilter: 'blur(5px) contrast(100%)', backgroundColor: 'rgba(0,0,0,0.5)'}}
